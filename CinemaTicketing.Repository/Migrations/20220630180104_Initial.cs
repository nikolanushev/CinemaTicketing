        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieDesrciption = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    CinemaUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingCarts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShoppingCarts_AspNetUsers_CinemaUserId",
                        column: x => x.CinemaUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieTickets_Tickets_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MovieTicketId = table.Column<Guid>(nullable: false),
                    OrderId = table.Column<Guid>(nullable: false),
                    Id = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieTicketInOrder", x => new { x.MovieTicketId, x.OrderId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketInShoppingCarts", x => new { x.MovieTicketId, x.ShoppingCartId });
                    table.ForeignKey(
                        name: "FK_TicketInShoppingCarts_ShoppingCarts_MovieTicketId",
                        column: x => x.MovieTicketId,
                        principalTable: "ShoppingCarts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketInShoppingCarts_MovieTickets_ShoppingCartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCarts_CinemaUserId",
                table: "ShoppingCarts",
                column: "CinemaUserId",
                unique: true,
                filter: "[CinemaUserId] IS NOT NULL");
